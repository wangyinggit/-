...
import common.Util.HttpResp;

public class Hello {
    public static void main( String[] args) throws Exception {
        Api api = new common.Api();
        String app_id = "100001";
        String app_key = "123456";
        String pd_id = "120572";
        String pd_key = "G8JmAjFBD+LdIwmil5wibcv6S0ty7OP/";
        ...
        // 通过文件进行验证码识别,请使用自己的图片文件替换,··················存放图片地址
        String img_file = "E:\\photo\\captcha.png";
        ...
        System.out.println(resp.pred_resl);
